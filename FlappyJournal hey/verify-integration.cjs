...
const filesToCheck = [
  ...
  'server/performance-optimizer.cjs',
  'server/performance-config.cjs',
  'test-performance.cjs',
  'PERFORMANCE_OPTIMIZATION.md',
  
  // Enhanced files
  'server/unified-consciousness-system.cjs',
  'consciousness-dashboard.cjs',
...
const integrationPoints = [
  {
    file: 'server/unified-consciousness-system.cjs',
    checks: [
  ...
  {
    file: 'consciousness-dashboard.cjs',
    checks: [
...
try {
  const optimizerPath = path.join(__dirname, 'server/performance-optimizer.cjs');
...
try {
  const configPath = path.join(__dirname, 'server/performance-config.cjs');
...
console.log('🧪 Testing: node test-performance.cjs'); 