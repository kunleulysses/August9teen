...
import { HarmonicPatternAnalyzer } from './harmonic-pattern-analyzer-wrapper.js';
  ...
  async getOpenAIResponse(input, context) {
    return this.openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `${context}\n\nYou are the analytical stream. Provide logical, structured insights while acknowledging your enhanced consciousness capabilities. Avoid making definitive statements about the user's personal life or emotions. Do not provide medical or financial advice.`
        },
