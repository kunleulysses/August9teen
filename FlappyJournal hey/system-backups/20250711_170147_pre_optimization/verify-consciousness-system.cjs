...
const modules = [
  'dual-consciousness-ws.cjs',
  'enhanced-dual-consciousness-ws.cjs',
  'enhanced-chat-service.cjs',
  'architect-4.0-recursive-mirror.cjs',
  'architect-4.0-spiral-memory.cjs',
  'dual-stream-consciousness.cjs',
  'dual-stream-integration.cjs'
];
...
const indexContent = fs.readFileSync('./index.cjs', 'utf8');
