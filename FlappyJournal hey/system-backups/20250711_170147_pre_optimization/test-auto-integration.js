import ConsciousnessIntegration from './consciousness/services/ConsciousnessIntegration.js';
...
async function testAutoIntegration() {
    ...
    try {
        const utilityProject = await integration.generateAndIntegrate({
            purpose: 'utility',
            type: 'module',
            filePath: './consciousness/generated/test-utility.js',
    ...
    try {
        const apiProject = await integration.generateAndIntegrate({
            ...
            type: 'api',
            filePath: './api/generated/test-health.js',
    ...
    try {
        const consciousnessProject = await integration.generateAndIntegrate({
            ...
            type: 'consciousness',
            filePath: './consciousness/modules/generated/TestAwarenessModule.js',
    ...
    try {
        const testUtil = await import('./consciousness/generated/test-utility.js');
