...
try {
    ...
    httpsServer.listen(PORT, '0.0.0.0', () => {
        ...
        console.log('');
        console.log('⚠️  Note: Self-signed certificate will show a warning in browsers.');
        console.log('   Click "Advanced" → "Proceed to august9teen.com (unsafe)" to access.');
        console.log('');
        console.log('🛑 Press Ctrl+C to stop the server');
    });
} catch (error) {
    console.log('❌ Failed to start HTTPS server. Starting HTTP server...');
