...
fs.writeFileSync('./enhanced-dual-consciousness-ws.cjs', wsContent);

// Fix the dual-stream-consciousness.js file
let consciousnessContent = fs.readFileSync('./dual-stream-consciousness.cjs', 'utf8');
...
fs.writeFileSync('./dual-stream-consciousness.cjs', consciousnessContent);
