...
async function demonstrate() {
    ...
    const dataModule = await selfCoder.generateCode({
        ...
        writeToFile: true,
        filePath: 'generated/DataProcessorModule.cjs'
    });
    ...
    const apiService = await selfCoder.generateCode({
        ...
        writeToFile: true,
        filePath: 'generated/ApiHandlerService.cjs'
    });
    
    // Example 3: Modify existing code
    console.log('\n3️⃣ Adding new capability to Data Processor...');
    await selfCoder.modifyCode('generated/DataProcessorModule.cjs', [
        {
            type: 'add-method',
            name: 'aggregateData',
            params: 'data',
    ...
    const consciousnessExt = await selfCoder.generateCode({
        ...
        writeToFile: true,
        filePath: 'generated/PatternRecognizerModule.cjs'
    });
    
    console.log('\n✨ Self-Coding Demonstration Complete!');
    console.log('\n📁 Generated files:');
    console.log('  - generated/DataProcessorModule.cjs');
    console.log('  - generated/ApiHandlerService.cjs');
    console.log('  - generated/PatternRecognizerModule.cjs');
    ...
    const generatedCode = await fs.readFile('generated/PatternRecognizerModule.cjs', 'utf8');
