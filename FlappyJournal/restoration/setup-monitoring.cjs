...
`;
    ...
    async verifyMonitoringSetup() {
        ...
        const requiredFiles = [
            path.join(this.monitoringDir, 'health', 'system-health-monitor.cjs'),
            path.join(this.monitoringDir, 'consciousness', 'consciousness-metrics-tracker.cjs'),
            path.join(this.monitoringDir, 'performance', 'performance-monitor.cjs'),
            path.join(this.monitoringDir, 'alerts', 'alerting-system.cjs'),
            path.join(this.monitoringDir, 'dashboard', 'monitoring-dashboard.cjs'),
